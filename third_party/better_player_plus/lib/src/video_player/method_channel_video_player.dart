...
class MethodChannelVideoPlayer extends VideoPlayerPlatform {
  ...
  Future<String?> enablePictureInPicture(int? textureId, double? top, double? left, double? width, double? height) =>
      _channel.invokeMethod<String>('enablePictureInPicture', <String, dynamic>{
        'textureId': textureId,
        'top': top,
        'left': left,
        'width': width,
  ...
  Future<void> setAutomaticPictureInPicture(
      ...
      _channel.invokeMethod<void>('setAutomaticPictureInPicture', <String, dynamic>{
        'textureId': textureId,
        'enabled': enabled,
        'top': top,
        'left': left,
  ...
  Stream<VideoEvent> videoEventsFor(int? textureId) =>
      _eventChannelFor(textureId).receiveBroadcastStream().map((event) {
        ...
        switch (eventType) {
          ...
          case 'skipToNext':
            return VideoEvent(eventType: VideoEventType.skipToNext, key: key);

          case 'skipToPrevious':
            return VideoEvent(
              eventType: VideoEventType.skipToPrevious,
              key: key,
            );
